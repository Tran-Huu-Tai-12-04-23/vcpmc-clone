    ...
    <div className="w-full">
      ...
      <div className="mt-4  flex  items-start justify-between gap-8">
        <div className="flex w-[274px] flex-shrink-0 flex-col gap-4 rounded-lg">
          ...
          <h5 className="border-second border-b-[1px] border-solid pb-4 text-[24px] font-semibold">
            Top ca khúc 2021
          </h5>
          ...
          <p className="border-second border-b-[1px] border-solid pb-4 pr-4 text-size-primary text-third ">
