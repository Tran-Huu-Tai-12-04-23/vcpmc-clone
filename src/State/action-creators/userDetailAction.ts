...
import { getUserDetailByID, updateUserDetailById } from '../../Service/userDetailService';
import { UserDetailAction, UserDetailActionType } from '../action-types/userDetail.action';
